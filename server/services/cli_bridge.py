    ...
    def generate_command(self, opp_id: str) -> str:
        ...
        if has_roster:
            ...
            prompt = (
                ...
                f"## How Might We\n"
                f"[Reframe this as a specific HMW question — e.g., 'HMW make fresh groceries a habitual purchase on tMart?' "
                f"The HMW should be specific enough to constrain the investigation but broad enough to invite multiple approaches.]\n\n"
                f"## What the data says\n"
                f"[2-3 bullet points connecting their idea to real data/strategy from the context files you just read — cite specific metrics, segments, or strategy references]\n\n"
                f"## To sharpen\n"
