...
class CliBridge:
    ...
    def generate_assemble_command(self, opp_id: str) -> str:
        ...
        prompt = (
            ...
            f"- You MUST update {ws_path}/opportunity.json with the current roster draft "
            f"BEFORE producing your response. Use the Write tool to save the roster array "
            f"and append to refinement_history. This file write is mandatory on every turn.\n"
            ...
            f"after the first. Do NOT skip the file write."
        )
